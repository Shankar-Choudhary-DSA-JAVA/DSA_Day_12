...
public class Demo_12_WrapperClasses {
    public static void main(String[] args) {
        ...
        a.add(y);
        a.add(x); //Autoboxing means we convert prim datatype in to objects; .add(Integer x); automatically converted int x in to integer by add methods
        a.add(10);
        a.add(20);
        a.add(11);
        a.add(13);
